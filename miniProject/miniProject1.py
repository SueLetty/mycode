...
def yearToZodiac():
    ...
    # print a question
    print("Do you want to know your (somoone's) Chinese Zodiac sign?")
    ...
    while condition:
        ...
        year = input("Please type the year you (someone) was born(example: 2020): ")
...
def main():
    ...
    while condition:
        ...
        print("\t1. using a year to check Chinese Zodiac")
        print("\t2. using a Chinese Zodic to check years")
        num = input(">")
        if num.isdigit():
            if num == "1":
                yearToZodiac()
